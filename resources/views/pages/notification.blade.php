...
@section('content')
	...
	@if( Auth::user()->status == 1 )
		...
		<ul class="list-group">
			...
			<a href="">Jonathan Petit</a> demande l’accès au cours de <a href="{{ action( 'CoursesController@view', [ 'id' => 18 ] ) }}">Néérlandais 3TQ</a><a class="btn badge btn-danger">Refuser</a><a class="btn badge btn-success">Ajouter</a>
			</li>
		</ul>
	@elseif( Auth::user()->status == 2 )
		<ul class="list-group">
			...
			<li class="list-group-item">Votre demande d’ajout au cours de Néerlandais de M. Poinvert à été accepter<a href="{{ action( 'CoursesController@view', ['id' => 18, 'action' => 1] ) }}" class="btn badge">Accéder au cours</a></li>
		</ul>
	@endif
@endsection