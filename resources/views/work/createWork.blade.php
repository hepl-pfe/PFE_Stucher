    ...
    <div class="spaceContainer">
    	<form action="" method="post">
            ...
            <div class="form-group">
                ...
                <label for="title">Ajouter le titre au devoir</label>
    		...
    		<div class="form-group text-center">
                @if (isset( $seance ))
                    <a class="btn btn-back" href="{!! action( 'SeanceController@view', ['id' => $seance->id] ) !!}">Annuler</a>
                @elseif ( isset( $course ) )
                    <a class="btn btn-back" href="{!! action( 'CourseController@view', ['id' => $course->id, 'status' => 1] ) !!}">Annuler</a>
                @else
                    <a class="btn btn-back" href="{!! URL::previous() !!}">Annuler</a>
                @endif
