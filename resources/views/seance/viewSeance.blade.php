			      		...
			      		<ul class="panel-body list-group">
							@foreach ($tests as $test)
								<li class="list-group-item">
									<h3>{{$test->title}} <a href="" class="btn badge btn-danger pull-right">Supprimer</a><a href="" class="btn badge btn-warning pull-right">modifier</a></h3>
									<p>
										{{$test->description}}
									</p>
								</li>
			      	...
			      	<div class="panel-warning">
			      		...
			      		<ul class="panel-body list-group">
							@foreach ($works as $work)
								<li class="list-group-item">
									<h3>{{$work->title}} <a href="" class="btn badge btn-danger pull-right">Supprimer</a><a href="" class="btn badge btn-warning pull-right">modifier</a></h3>
									<p>
										{{$work->description}}
									</p>
								</li>
